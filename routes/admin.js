...
router.delete('/blockuser/:id',adminController.verifyToken,adminController.blockStudent)
router.delete('/unblockuser/:id',adminController.verifyToken,adminController.unblockStudent)
